 ...
 * 
 * @author MasudRahman
 * Utlity class, loads content into memory from a file
 * 
 */
...
public class ContentLoader {
	...
	public static HashMap<String, Integer> loadWordMap(String fileURL) {
		// loading the word pairs
		ArrayList<String> lines = getAllLinesOptList(fileURL);
	...
	public static HashMap<Integer, String> loadBugQueryLabels(String fileURL) {
		ArrayList<String> lines = getAllLinesOptList(fileURL);
